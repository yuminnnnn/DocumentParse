...
class PaddleOcrOptions(OcrOptions):
    ...
    lang: List[str] = ["korean"]  # Default to Korean, can be ['en'], ['ch'], etc.
    use_angle_cls: bool = True
    debug_draw_ocr: bool = False
...
class OcrEnhancedPipelineOptions(PaginatedPipelineOptions):
    """Options for the OCR Enhanced Pipeline."""
